<?php
    ...
    $consulta = $cn->query("select * from tb_guitarra where cod_guitarra = '$cd'");
    //criando um array para exibir os dados
    $exibe = $consulta->fetch(PDO::FETCH_ASSOC);
    // comando para excluir o registro pelo cd_livro que foi recebido na variavel.
    $excluir = $cn->query("delete from tb_guitarra where cod_guitarra = '$cd'");

    $foto1 = $exibe['nome_imagem'];  //salvando nesta variável a imagem do select
