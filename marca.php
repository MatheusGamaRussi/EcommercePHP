...
<body style="background-color: #343440">
    <?php
        ...
        $consulta = $cn->query("select cod_guitarra, nome, preco, nome_imagem, qt_estoque from vw_guitarra where nome_marca = '$mc';");
    ?>

    <h1 class="jumbotron text-center" style="background-image: url(img/modelos.png); background-position: left bottom; color: #fff; font-size: 4em; font-weight: bold;"><?php echo $mc ?></h1>
